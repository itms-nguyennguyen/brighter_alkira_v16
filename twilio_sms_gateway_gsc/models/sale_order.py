...
class SaleOrder(models.Model):
    ...
    def action_confirm(self):
        ...
        if (twilio_sms_account and twilio_sms_account.is_confirm_so_to_send_sms and
                twilio_sms_account.sms_so_confirm_template_id):
            for sale in self:
                ...
                customer_number = sale.partner_id.mobile or sale.partner_id.phone or ""
                datas = {
