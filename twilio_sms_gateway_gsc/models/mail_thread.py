...
class MailThread(models.AbstractModel):
    ...
    def _message_sms_with_template_twilio(self, template=False, template_xmlid=False, template_fallback='',
                                          partner_ids=False, **kwargs):
        """ Shortcut method to perform a _message_sms with sms.template.

        :param template: a valid sms.template record;
        :param template_xmlid: XML ID of sms.template (if no template given);
