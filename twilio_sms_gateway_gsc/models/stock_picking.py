...
class StockPicking(models.Model):
    ...
    def _action_done(self):
        ...
        twilio_sms_accounts = self.env['twilio.sms.gateway.account'].sudo().search([('state', '=', 'confirmed')],
        ...
        if (twilio_sms_account and twilio_sms_account.is_validate_do_to_send_sms and
                twilio_sms_account.sms_do_validate_template_id):
            for picking in self:
                ...
                customer_number = picking.partner_id.mobile or picking.partner_id.phone or ""
                datas = {
